#ifndef _STL_ALGORITHM_HPP_
#define _STL_ALGORITHM_HPP_

#include <string>

/** @defgroup base stl/algorithm/base
 * @brief Implementation of the Base algorithm.
 *
**/
namespace stl{
    ...
    template<unsigned N> struct base {
        /** @ingroup base Function declaration
		  * @brief encrypt the data through the base algorithm.
		  * @param[in] binary any type of data
		  * @return the encrypt data
		 **/
        static std::string encode( const std::string &binary );
         /** @ingroup base Function declaration
		  * @brief decrypt the data through the base algorithm.
		  * @param[in] text the encrypted data
		  * @return the decrypt data
		 **/
        static std::string decode( const std::string &text );
        /** @ingroup base Function declaration
		  * @brief encrypt the data through the base algorithm.
          * @param[out] out the decrypt data
		  * @param[in] binary any type of data
		  * @return true: success, false: failed
		 **/
        static bool encode( std::string &out, const std::string &binary );
        /** @ingroup base Function declaration
		  * @brief decrypt the data through the base algorithm.
          * @param[out] out the decrypt data
		  * @param[in] text the encrypted data
		  * @return true: success, false: failed
		 **/
        static bool decode( std::string &out, const std::string &text );
    };
    /*!
    \typedef base64
        Define the class of base64.
    */
    typedef base<64> base64;
    /*!
    \typedef base85
        Define the class of base85.
    */
    typedef base<85> base85;
    /*!
    \typedef base91
        Define the class of base91.
    */
